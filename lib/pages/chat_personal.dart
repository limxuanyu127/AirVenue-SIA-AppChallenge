...
class ChatBot extends StatelessWidget {
  ...
  @override
  ChatBot({Key key, @required this.peerId, @required this.peerName})
      : super(key: key);
...
class ChatBotScreen extends StatefulWidget {
  ...
  ChatBotScreen({Key key, @required this.peerId}) : super(key: key);

  @override
  State createState() => new ChatBotScreenState(peerId: peerId);
}

class ChatBotScreenState extends State<ChatBotScreen> {
  ChatBotScreenState({Key key, @required this.peerId});
  ...
  readData() async {
    final QuerySnapshot result = await Firestore.instance
        .collection('users')
        .document(id)
        .collection('chatUsers').where('id', isEqualTo: id)
        .getDocuments();
